...
CSV_PATH          = Path(__file__).parent / "backend" / "data" / "bukgu_gap.csv"
POLL_HISTORY_PATH = Path(__file__).parent / "backend" / "data" / "poll_history.json"
CONTEXT_PATH      = Path(__file__).parent / "backend" / "data" / "context.md"
