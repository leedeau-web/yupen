...
def generate_personas_db(db_path: Path):
    ...
    def _mayor_pref(c):
        ...
        if c == '하정우': return _pick_w(['전재수','박형준','미정'], [92,  3,  5])
        if c == '한동훈': return _pick_w(['전재수','박형준','미정'], [15, 65, 20])
        if c == '박민식': return _pick_w(['전재수','박형준','미정'], [10, 72, 18])
        return                   _pick_w(['전재수','박형준','미정'], [43, 37, 20])  # 미정: 3권역 중도층 접전

    # ── ① 연령×후보 그룹 (1~11차 가중평균) ──────────────────────────────────
    _age_groups = [
        (18,29,'하정우',4477),(18,29,'한동훈',4154),(18,29,'박민식',3589),(18,29,'미정',3697),
        (30,39,'하정우',4510),(30,39,'한동훈',4100),(30,39,'박민식',4283),(30,39,'미정',3024),
        (40,49,'하정우',8695),(40,49,'한동훈',3302),(40,49,'박민식',2896),(40,49,'미정',1636),
        (50,59,'하정우',10319),(50,59,'한동훈',5639),(50,59,'박민식',4995),(50,59,'미정',1698),
        (60,69,'하정우',10715),(60,69,'한동훈',8032),(60,69,'박민식',6315),(60,69,'미정',2487),
        (70,88,'하정우',6758),(70,88,'한동훈',7713),(70,88,'박민식',6854),(70,88,'미정',2552),
    ]
